...
// findBlock(type: string, maxRadius: number, numFind : number = 1): Block [] - Returns the an array of blocks closest to the simulated player of the type given within the radius.
