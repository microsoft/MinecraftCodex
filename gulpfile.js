...
function deploy_localmc_server() {
  console.log("Copying world 'server/' to '" + getTargetServerPath() + "'");
  return gulp.src([getDevServerPath() + "/**/*"]).pipe(gulp.dest(getTargetServerPath()));
}
